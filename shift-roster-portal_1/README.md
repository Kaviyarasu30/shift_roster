...
4. **Rules**:
   ...
   - **Minimum staff per shift** — how many people must be working Morning/Evening/Night every single day. If leaves or weekly-offs push a shift below this number on some day, that day is listed in the Warnings tab of the Excel file so you can manually adjust (e.g. change someone's weekly-off day, or move a leave).
